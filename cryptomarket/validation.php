...
if ($cart->id_customer == 0 OR $cart->id_address_delivery == 0 OR $cart->id_address_invoice == 0 OR !$cryptomarket->active)
...
if (!$authorized)
        die($cryptomarket->l('This payment method is not available.', 'validation'));
echo $cryptomarket->execPayment($cart);
